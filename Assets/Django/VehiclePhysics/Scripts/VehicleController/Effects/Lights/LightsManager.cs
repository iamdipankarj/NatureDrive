...
namespace Django.VehiclePhysics.Effects
{
    /// <summary>
    ...
    public partial class LightsMananger : Effect
    {
        ...
        {
            get { return (int) ((vehicleController.realtimeSinceStartup - _leftBlinkerTurnOnTime) * 2) % 2 == 0; }
        }

        public bool RightBlinkerState
        {
            get { return (int) ((vehicleController.realtimeSinceStartup - _rightBlinkerTurnOnTime) * 2) % 2 == 0; }
        }
        ...
        public override void VC_Update()
        {
            ...
            if (!vehicleController.MultiplayerIsRemote)
            {
                ...
                {
                    if (vehicleController.input.states.lowBeamLights)
                    {
                ...
                {
                    if (vehicleController.input.states.highBeamLights)
                    {
                ...
                if (extraLights != null)
                {
                    if (vehicleController.input.states.extraLights)
                    {
                        extraLights.Toggle();
