using System;
using Django.VehiclePhysics.GroundDetection;
...
namespace Django.VehiclePhysics.Powertrain
{
    ...
    public partial class WheelComponent : PowertrainComponent
    {
        ...
        protected override void VC_Initialize()
        {
            ...
            _initialWheelInertia = wheelUAPI.Inertia;
...
#if Django_WC3D
            drawer.Info("Detected WheelController3D.\r\nIf this is not correct remove Django_WC3D from the Scripting Define Symbols.");
#else
