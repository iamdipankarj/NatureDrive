...
namespace Django.VehiclePhysics
{
    ...
    /// </summary>
    [Serializable]
    [CreateAssetMenu(fileName = "Django Vehicle Physics", menuName = "Django/Vehicle Physics/State Settings", order = 1)]
    public partial class StateSettings : ScriptableObject
    {
        ...
        public void Reload()
        {
            List<string> fullNames = AppDomain.CurrentDomain.GetAssemblies().SelectMany(assembly => assembly.GetTypes())
            ...
            foreach (string fullName in fullNames)
            {
                ...
                {
                    definitions.Add(new StateDefinition(fullName, true, -1));
                }
            }
    ...
    public partial class StateSettingsEditor : NVP_NUIEditor
    {
        public override bool OnInspectorNUI()
        {
            ...
            drawer.Info(
                ...
                "affect vehicles enabled after the change was made.", MessageType.Warning);
