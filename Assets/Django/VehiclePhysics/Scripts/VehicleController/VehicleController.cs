...
namespace Django.VehiclePhysics {
  ...
  public partial class VehicleController : Vehicle {
    public const string DEFAULT_RESOURCES_PATH = "Django Vehicle Physics/Defaults/";

    public Brakes brakes = new();
    public EffectManager effectsManager = new();
    public GroundDetection.GroundDetection groundDetection = new();
    public VehicleInputHandler input = new();
    public ModuleManager moduleManager = new();
    public Powertrain.Powertrain powertrain = new();
    public SoundManager soundManager = new();
    public Steering steering = new();
  ...
  public partial class VehicleControllerEditor : NVP_NUIEditor {
    ...
    public override bool OnInspectorNUI() {
      ...
      logoRect.height = 60f;
      drawer.DrawEditorTexture(logoRect, "Django Vehicle Physics/Editor/logo_bg", ScaleMode.ScaleAndCrop);
      drawer.DrawEditorTexture(
          new Rect(logoRect.x + 8f, logoRect.y + 11f, logoRect.width - 8f, logoRect.height - 22f),
          "Django Vehicle Physics/Editor/logo_light", ScaleMode.ScaleToFit);
    ...
    private void DrawAboutTab() {
      AssetInfo assetInfo = Resources.Load("Django Vehicle Physics/Django Vehicle Physics AssetInfo") as AssetInfo;
      if (assetInfo == null) {
        return;
      }
