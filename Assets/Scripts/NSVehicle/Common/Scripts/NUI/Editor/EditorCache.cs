...
namespace NSVehicle {
  public static class EditorCache {
    ...
    private static Dictionary<string, float> heightCache = new();
    private static Dictionary<string, ReorderableList> reorderableListCache = new();
    private static Dictionary<string, bool> guiWasEnabledCache = new();
    private static Dictionary<string, NUIEditor> nuiEditorCache = new();
    private static Dictionary<string, bool> isExpandedCache = new();
    private static Dictionary<string, int> tabIndexCache = new();
    private static Dictionary<string, Texture2D> texture2DCache = new();
    private static Dictionary<string, SerializedProperty> serializedPropertyCache = new();
