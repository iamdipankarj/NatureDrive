...
using Django.VehiclePhysics2.Damage;
...
namespace Django.VehiclePhysics2.Sound.SoundComponents
{
    /// <summary>
    ...
    public partial class CrashComponent : SoundComponent
    {
        ...
        public override bool VC_Enable(bool calledByParent)
        {
            ...
            {
                vehicleController.onCollisionEnter.AddListener(PlayCollisionSound);
                return true;
            }
        ...
        public override bool VC_Disable(bool calledByParent)
        {
            ...
            {
                vehicleController.onCollisionEnter.RemoveListener(PlayCollisionSound);
                return true;
            }
