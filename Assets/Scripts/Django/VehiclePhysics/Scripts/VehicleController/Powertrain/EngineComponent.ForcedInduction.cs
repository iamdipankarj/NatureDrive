    ...
    public partial class EngineComponent
    {
        ...
        public partial class ForcedInduction
        {
            ...
            public void Update(EngineComponent engine)
            {
                ...
                {
                    boost = Mathf.Clamp01(engine.RPMPercent + 0.5f);
                }
                else
                {
                    float targetBoost;
                    ...
                    {
                        targetBoost = Mathf.Clamp01(engine.RPMPercent + 0.5f) * engine.ThrottlePosition;
                    }
                    ...
                    if (hasWastegate)
                    {
                        if (engine.ThrottlePosition < 0.3f && boost > 0.7f)
                        {
