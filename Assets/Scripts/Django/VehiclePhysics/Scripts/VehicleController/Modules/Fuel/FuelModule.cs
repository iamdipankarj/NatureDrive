...
namespace Django.VehiclePhysics2.Modules.Fuel
{
    /// <summary>
    ...
    /// </summary>
    [Serializable]
    public partial class FuelModule : VehicleComponent
    {
        /// <summary>
        ...
        public override void VC_FixedUpdate()
        {
            ...
            if (vehicleController.powertrain.engine.IsRunning)
            {
                ...
                consumptionPerHour = vehicleController.powertrain.engine.generatedPower / vehicleController.powertrain.engine.maxPower *
                ...
                amount -= consumptionPerHour / 3600 * vehicleController.fixedDeltaTime;
                amount = Mathf.Clamp(amount, 0f, capacity);

                if (amount == 0 && vehicleController.powertrain.engine.IsRunning)
                {
